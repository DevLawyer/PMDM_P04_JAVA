...
/**
 * This class is used tu implements de methods which update data from a file or
 * save data in a file.
 */
public class updateSaveData {
    ...
    public static void updateFromFile() {
        // This method loads in updatedList the information contained in a 
        // data.dat file, if there is any information to extract.
